/// All credits go to liyu1981/tmpfile.zig
...
pub inline fn tmpDirOwned(allocator: std.mem.Allocator, args: TmpDir.TmpDirArgs) !*TmpDir {
...
pub inline fn tmpFile(allocator: std.mem.Allocator, args: struct {
    tmp_dir: ?*TmpDir = null,
    prefix: ?[]const u8 = null,
    dir_prefix: ?[]const u8 = null,
    flags: std.fs.File.CreateFlags = .{ .read = true },
    ...
    if (args.tmp_dir) |tmp_dir| {
        ...
        var tmp_dir = try tmpDirOwned(allocator, .{
            .prefix = args.prefix,
            .opts = args.dir_opts,
        });
        _ = &tmp_dir;
